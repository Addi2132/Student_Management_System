...
const generateStudentId = () => {
    ...
    return studentInfo.some((student) => student.studentId === newId) ? generateStudentId() : newId;
};
    ...
    const { course } = await inquirer.prompt([
        {
            ...
            choices: ["Web Development", "Mobile Development", "AI", "Cloud Computing", "Blockchain", "Generative Ai"],
        },
    ]);
    ...
    const { choice } = await inquirer.prompt([
        {
            ...
            choices: ["Show Students", "Add Student", "Update Student", "Delete Student", "Show Status", "Enroll", "View Balance", "Pay Tuition", "Add Balance", "Exit"],
        },
    ]);
    switch (choice) {
        case "Add Student":
